...
namespace CMaurer.Common
{
    public class MAPI
    {
        ...
        IntPtr GetRecipients(out int recipCount)
        {
            ...
            // TODO
            // cmaurer
            // in DOT:NET 2.0 use int
            // in DOT:NET >= 4.0 use long

            //int ptr = (int)intPtr;  // DOT.NET 2.0
            long ptr = (long)intPtr;  // >= DOT.NET 4.0
        ...
        IntPtr GetAttachments(out int fileCount)
        {
            ...
            // cmaure rtodo
            //int ptr = (int)intPtr; // 2.0
            long ptr = (long)intPtr; // 4.0
        ...
        void Cleanup(ref MapiMessage msg)
        {
            ...
            {
            // cmaurer todo
                //ptr = (int)msg.recips;// 2.0
                ptr = (long)msg.recips;// 4.0
