...
namespace BitcoinLib.Test
{
    ...
    {
        public static void test_ripemd160_bouncycastle() // TODO use RIPEMD160 and no BouncyCastle!
        {
            object[] data =
            {
            ...
            for (int i = 0; i < data.Length; i++)
            {
                ...
                Console.WriteLine("ripemd160('" + input + "') = " + want + " (" + hex + ")");

                AssertTrue(hex.Equals(want));
            }
        }

        public static void test_ripemd160_chatgpt() // TODO use RIPEMD160 and no BouncyCastle!
        {
            object[] data =
            {
                "", "9c1185a5c5e9fc54612808977ee8f548b2258d31",
