...
/// <summary>
/// MurmurHash3.Hash32 is from https://github.com/JeremyEspresso/MurmurHash/tree/master
/// </summary>
public static class MurmurHash3
{
    public static uint Hash32(byte[] bytes, uint seed)
    {
        ReadOnlySpan<byte> span = bytes;
        return Hash32(ref span, seed);
    }
